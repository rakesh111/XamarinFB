...
{
	[Activity (Label = "SampleFb.Droid", MainLauncher = true)]
	public class Activity1 : Activity
	{

		private const string AppId = "360818430783991";
		...
		protected override void OnCreate (Bundle bundle)
		{
			...
			btnLogin.Click += (sender, e) => {
				var webAuth = new Intent (this, typeof (FbAuth));
